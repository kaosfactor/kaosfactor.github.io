const MORNING = [{name: "Now", subpages: [{name: "current-page", duration: 16000}, {name: "radar-page", duration: 10000}]},{name: "Today", subpages: [{name: "today-page", duration: 10000}]},{name: "Tonight", subpages: [{name: "tonight-page", duration: 9000}]},{name: "Beyond", subpages: [{name: "tomorrow-page", duration: 9000}, {name: "7day-page", duration: 9000}]},]
const NIGHT = [{name: "Now", subpages: [{name: "current-page", duration: 16000}, {name: "radar-page", duration: 10000}]},{name: "Tonight", subpages: [{name: "tonight-page", duration: 9000}]},{name: "Beyond", subpages: [{name: "tomorrow-page", duration: 9000}, {name: "tomorrow-night-page", duration: 9000}, {name: "7day-page", duration: 9000}]},]
const SINGLE = [{name: "Alert", subpages: [{name: "single-alert-page", duration: 7000}]},{name: "Now", subpages: [{name: "current-page", duration: 16000}, {name: "radar-page", duration: 9000}, {name: "zoomed-radar-page", duration: 8000}]},{name: "Tonight", subpages: [{name: "tonight-page", duration: 8000}]},{name: "Beyond", subpages: [{name: "tomorrow-page", duration: 8000}, {name: "7day-page", duration: 8000}]},]
