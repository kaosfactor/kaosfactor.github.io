...
function fetchRadarImages(){
  ...
  radarImage.setAttribute("src", "https://kaosfactor.github.io/staticradar1.html");
  ...
  if(alertsActive){
   ...
   zoomedRadarImage.setAttribute("src", "https://kaosfactor.github.io/staticradar2.html");
