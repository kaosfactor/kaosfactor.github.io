...
const MORNING = [{name: "Now", subpages: [{name: "current-page", duration: 15000}, {name: "radar-page", duration: 12000}]},{name: "Today", subpages: [{name: "today-page", duration: 9000}]},{name: "Tonight", subpages: [{name: "tonight-page", duration: 9000}]},{name: "Beyond", subpages: [{name: "tomorrow-page", duration: 9000}, {name: "7day-page", duration: 9000}]},]
const NIGHT = [{name: "Now", subpages: [{name: "current-page", duration: 15000}, {name: "radar-page", duration: 12000}]},{name: "Tonight", subpages: [{name: "tonight-page", duration: 90000}]},{name: "Beyond", subpages: [{name: "tomorrow-page", duration: 9000}, {name: "tomorrow-night-page", duration: 9000}, {name: "7day-page", duration: 9000}]},]
const SINGLE = [{name: "Alert", subpages: [{name: "single-alert-page", duration: 7000}]},{name: "Now", subpages: [{name: "current-page", duration: 14000}, {name: "radar-page", duration: 11000}, {name: "zoomed-radar-page", duration: 11000}]},{name: "Tonight", subpages: [{name: "tonight-page", duration: 8000}]},{name: "Beyond", subpages: [{name: "tomorrow-page", duration: 8000}, {name: "7day-page", duration: 9000}]},]
...
function checkStormMusic(){
  if(currentCondition.toLowerCase().includes("storm")){
    music= new Audio("assets/music/storm.mp3");
  }
}
...
function startAnimation(){
  ...
  //jingle.play();
  setTimeout(startJingle, 1000)
  setTimeout(startMusic, 6500)
  executeGreetingPage();
}
